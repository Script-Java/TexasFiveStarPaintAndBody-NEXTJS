...
const jsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Custom Paint & Refinishing' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Auto Restoration' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Paintless Dent Repair' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Scratch & Paint Chip Repair' } },
  ...
  return (
    <html lang="en">
        ...
        <Script 
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-5QSGHZL2');
            `
          }}
        />
      ...
      >
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-5QSGHZL2"
            height="0"
            width="0"
